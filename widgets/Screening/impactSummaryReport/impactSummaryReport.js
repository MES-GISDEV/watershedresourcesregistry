    ...
    _showReport: function () {
      ...
      if (data.rows && data.rows.length > 0) {
        ...
        for (aggregatedId in aggregatedObj) {
          ...
          //Adding cusom code to create a How's My Waterway link
          if(data.title == "303d Streams - Line"){
            newRowInAggregatedData[0] = "https://mywaterway.epa.gov/community/"+newRowInAggregatedData[0]+"/overview";
