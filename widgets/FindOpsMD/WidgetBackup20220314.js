      ...
      //methods to communication with app container:
       ...
       _toggleAddLocation: function () {
		...
		_setAllDropdownData: function(){
			fedHuc8 =  esriRequest({
               url: "https://services.mesgis.com/arcgis/rest/services/WRR/WatershedsHUC12/MapServer/4/query?where=1=1&outFields=COUNTY%2C+HUC8%2C+Name&orderByFields=COUNTY&returnGeometry=false&returnDistinctValues=true&f=json",
               handleAs: "json",
			...
			fedHuc12 =  esriRequest({
               url: "https://services.mesgis.com/arcgis/rest/services/WRR/WatershedsHUC12/MapServer/3/query?where=STATE_NAME=%27Maryland%27&outFields=NAME_1%2C+HUC12%2C+Name&orderByFields=NAME_1&returnGeometry=false&returnDistinctValues=true&f=json",
               handleAs: "json",
               callbackParamName: "callback"
           }, {
               useProxy: false
			...
			mdHuc8 =  esriRequest({
               url: "https://services.mesgis.com/arcgis/rest/services/WRR/WatershedsHUC12/MapServer/5/query?where=1=1&outFields=COUNTY%2C+mde8digt%2C+mde8name&orderByFields=COUNTY&returnGeometry=false&returnDistinctValues=true&f=json",
               handleAs: "json",
               callbackParamName: "callback"
           }, {
               useProxy: false
