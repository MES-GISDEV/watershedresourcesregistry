...
define({
  root: ({
    ...
    unableToDrawBuffer: "Unable to draw buffer.", // Shown as alert message if unable to draw buffer
    ...
    reportsTab: {
      ...
      showAreaInText: "Show areas in", // Shown as a prefix text to toggle area
      metricUnitsText: "Metric Units", // Shown as a text option to convert area to metric unit
      standardUnitsText: "Standard Units", // Shown as a text option to convert area to standard unit
      downloadButtonTooltip: "Download", // Shown as a tooltip for download button
      printButtonTooltip: "Create Report", // Shown as a tooltip for print button
	  ...
	  //FK added line immediate below 2022-08-19
	  printLayoutTitle: "Map Title",
