...
define([
	...
	return declare([_WidgetBase, _TemplatedMixin], {
		...
		addLayerNode: function(layerInfo, level, toTableNode, position) {
			...
			//FK Testing - Turn off any layers that are not visible using the layerInfo
			var sdClass = '';
			try {
			...
			*/
			...
			/*
			//FK Testing Begin Nope, didnt' work, looking at WRRLayerList Widget line 378
		...
		hasContentMenu: function() {
			...
			***************************************************/
			...
			var frankStyle = myLayerNode.style; //like I have style
