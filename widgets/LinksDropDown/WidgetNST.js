...
function(declare, html, query, on, lang, _WidgetsInTemplateMixin, BaseWidget, TabContainer3, aspect, dom, domConstruct) {
    var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
		...
		startup: function() {		
			...
			noStateTools = "This set of tools will be available soon";
			domConstruct.place('<a ' + noStateTools + '> <div style="left: 0px; top: ' + topLocation + 'px; right: auto; bottom: auto; width: 100%; height: 40px; padding: 0px; z-index: auto;line-height: 40px" class="jimu-widget-onscreen-icon-link-NST"> <center><span class="droplabel" >' + noStateTools + '</span></center> </div></a>' ,dom.byId("drawerMappingNode"));
			
			//loop through links to add to list. Uncomment the loop block of codes when states tools become available. NST = No State Tools
