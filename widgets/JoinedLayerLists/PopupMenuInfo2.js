...
define([
  ...
  var clazz = declare([], {
    ...
    getDeniedItems: function() {
      ...
      all({
        ...
        supportTableInfo.isSupportedLayer = true;
      ...
      this._layerInfo.getSupportTableInfo().then(lang.hitch(this, function(supportTableInfo) {
        ...
        if(this._isSupportedByAT(attributeTableWidgetEle, supportTableInfo)) {
          ...
          .then(lang.hitch(this, function() {
            evt.layerListWidget.wabWidget.publishData({
  ...
  clazz.create = function(layerInfo, layerListWidget) {
    ...
    var itemInfoCategoreList = {
      //Rootlayer used for the grouped layer list popup options
      'RootLayer': [{
        key: 'zoomto'
      }, {
        key: 'transparency'
      ...
      //Rootlayer used for the grouped layer list popup options if sublayers exist
      'RootLayer2': [{
        key: 'zoomto'
      }, {
        key: 'transparency'
      ...
      //This used for the additional function layer list
    ...
    layerInfo.getLayerType().then(lang.hitch(this, function(layerType) {
      ...
      } else if (isRootLayer && layerInfo._subLayerVisible) {
        itemInfoCategory = "RootLayer2";
      } else if (isRootLayer) {
