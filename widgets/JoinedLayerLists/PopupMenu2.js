define([
	...
	_TemplatedMixin, HorizSlider, HorzRuleLabels, template, domStyle, NlsStrings, PopupMenuInfo2) {
	return declare([DropMenu, _TemplatedMixin], {
		...
		_changeItemsUI: function() {
			...
			/*FK 2022-01-09 Added this block of code to allow WRR list
			to open in new tab*/
			//add tartet to a tag.
		...
		openDropMenu: function() {
			...
			if (!this.dropMenuNode) {
				...
				PopupMenuInfo2.create(this._layerInfo, this.layerListWidget)
