...
define([
    ...
    'dojo/query',
    'dijit/registry',
    'dojo/text!./LayerList.html',    
    './LayerListView',
    './NlsStrings',
    'jimu/LayerInfos/LayerInfos'
  ],
  function(_WidgetBase, _TemplatedMixin, declare, lang, array, html, dom, on,
  query, registry, template, LayerListView, NlsStrings, LayerInfos) {
